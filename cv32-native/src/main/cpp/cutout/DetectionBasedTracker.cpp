//
// Created by silen on 07/07/2017.
//
#include "com_foretree_xopencv_DetectionBasedTracker.h"
...
JNIEXPORT jlong JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeCreateObject
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeCreateObject enter");
    const char *jnamestr = jenv->GetStringUTFChars(jFileName, NULL);
    string stdFileName(jnamestr);
    jlong result = 0;

    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeCreateObject");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeCreateObject exit");
    return result;
}

JNIEXPORT void JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeDestroyObject
        (JNIEnv *jenv, jclass, jlong thiz) {
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeDestroyObject");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeDestroyObject exit");
}

JNIEXPORT void JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeStart
        (JNIEnv *jenv, jclass, jlong thiz) {
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeStart");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeStart exit");
}

JNIEXPORT void JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeStop
        (JNIEnv *jenv, jclass, jlong thiz) {
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeStop");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeStop exit");
}

JNIEXPORT void JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeSetFaceSize
        (JNIEnv *jenv, jclass, jlong thiz, jint faceSize) {
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeSetFaceSize -- BEGIN");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeSetFaceSize -- END");
}


JNIEXPORT void JNICALL Java_com_foretree_xopencv_DetectionBasedTracker_nativeDetect
        (JNIEnv *jenv, jclass, jlong thiz, jlong imageGray, jlong faces) {
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeDetect");
    ...
    LOGD("Java_com_foretree_xopencv_DetectionBasedTracker_nativeDetect END");
}
